...
import { bigshoe9, bigshoe10, bigshoe11   } from "../assets/images";
...
import ScrollToTop from "../components/ScrollToTop";
 ...
 const ShoeDetails1 = () => {
  ...
  const handleClick = () => navigate('/shoedetails2', { replace: true});
  const handleClick1 = () => navigate('/shoedetails3', { replace: true});
  const handleClick2 = () => navigate('/shoedetails4', { replace: true});
    ...
    <> <ScrollToTop />
     <div className="sm:mt-5 mt-[100px] mb-7">
      ...
      <div className=' sm:gap-6 gap-14 mb-10'>
         {productsArray.slice(8, -3).map((product, idx) => (
