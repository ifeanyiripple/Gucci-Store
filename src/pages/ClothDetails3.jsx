...
import { cloth1, cloth2, cloth3, cloth4 } from "../assets/images";
...
import ScrollToTop from "../components/ScrollToTop";
 ...
 const Details = () => {
  ...
  const handleClick = () => navigate('/clothdetails1', { replace: true});
  const handleClick1 = () => navigate('/clothdetails2', { replace: true});
    ...
    <><ScrollToTop />
     <div className="sm:mt-5 mt-[100px] mb-7">
      ...
      <div className=' sm:gap-6 gap-14 mb-10'>
         {productsArray.slice(6,-5).map((product, idx) => (
